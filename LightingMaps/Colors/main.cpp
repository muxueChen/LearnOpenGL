...
int main(int argc, const char * argv[]) {
    ...
    float vertices[] = {
        ...
        UFImage image = UFImage("/Users/chenxueming/Desktop/LearnOpenGL/LightingMaps/Colors/container2.png");
        UFImage mirrImage = UFImage("/Users/chenxueming/Desktop/LearnOpenGL/LightingMaps/Colors/container2_specular.png");
        while (!glfwWindowShouldClose(window))
        {
            ...
            glBindTexture(GL_TEXTURE_2D, mirrImage.glTexture());
