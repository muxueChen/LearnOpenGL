...
Shader * Shader:: setMat2(const std::string &name, const GLfloat *value) {
    glUniformMatrix2fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, value);
    return this;
}

Shader * Shader:: setMat3(const std::string &name, const GLfloat *value) {
    glUniformMatrix3fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE, value);
    return this;
}

Shader * Shader:: setMat4(const std::string &name, const GLfloat *value) {
