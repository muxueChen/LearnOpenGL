...
public:
    ...
    Shader * setMat2(const std::string &name, const GLfloat *value);
    Shader * setMat3(const std::string &name, const GLfloat *value);
    Shader * setMat4(const std::string &name, const GLfloat *value);
};
#endif /* Shader_hpp */
