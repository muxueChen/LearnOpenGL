...
int main(int argc, const char * argv[]) {
    ...
    LamplightShader *lamplightCode = new LamplightShader();
    Shader lampShader = Shader(lamplightCode);
    ...
    unsigned int specularMap = UFImage("/Users/chenxueming/Desktop/LearnOpenGL/LightCasters/LightCasters/container2_specular.png").glTexture();
        ...
        while (!glfwWindowShouldClose(window))
        {
            ...
            camera.Position.x = 10.0*sin(glfwGetTime());
            camera.Position.z = 10.0*cos(glfwGetTime());
